...
qint64 CwnSchemeAccess::CreateDb(  QString p_qstrKeyname, CdmScheme*& p_rpCdmDatabase )
{
...
qint64 CwnSchemeAccess::DeleteScheme(  QString p_qstrKeyname )
{
...
qint64 CwnSchemeAccess::ExistDb(  QString p_qstrKeyname, bool& p_bRet )
{
  qint64 lRet = CdmLogging::eDmUnknownDbAccessError;
...
qint64 CwnSchemeAccess::FindDatabase(  QString p_qstrKeyname, CdmScheme*& p_pCdmDatabaseManager )
{
  qint64 lRet = CdmLogging::eDmUnknownDbAccessError;
...
qint64 CwnSchemeAccess::FindDatabase( qint64 p_lSchemeId, CdmScheme*& p_pCdmDatabaseManager )
{
  qint64 lRet = CdmLogging::eDmUnknownDbAccessError;
...
qint64 CwnSchemeAccess::GetDatabaseList(  QList<QString>& p_rqvlDatabases )
{
  qint64 lRet = CdmLogging::eDmUnknownDbAccessError;
...
qint64 CwnSchemeAccess::UpdateDatabase(CdmScheme* p_pCdmDatabase)
{
...
int CwnSchemeAccess::DeleteLanguage(qint64 p_lDatabaseId, int p_iLanguageId)
{
...
int CwnSchemeAccess::AddLanguage(qint64 p_lDatabaseId, QString p_qstrLanguage)
{

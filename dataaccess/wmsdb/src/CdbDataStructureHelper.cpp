 ...
 ** Modulename: CdbDataStructureHelper.cpp
...
QString CdbDataStructureHelper::GetTableIdName()
{
   return "valueid";
}

QString CdbDataStructureHelper::GetTableName(CdbDataAccess::EodbcBaseType p_eType)
{
...
QString CdbDataStructureHelper::GetTableName(EdmValueType p_eDmValueType)
{
   QString qstrTableName;
...
QString CdbDataStructureHelper::GetDataFieldName()
{
   return "Val";
}
...
QString CdbDataStructureHelper::GetFirstMember(QString p_qstrMemberChain)
{
   QString qstrRet;
...
QString CdbDataStructureHelper::GetLastMember(QString p_qstrMemberChain)
{
   QString qstrRet;

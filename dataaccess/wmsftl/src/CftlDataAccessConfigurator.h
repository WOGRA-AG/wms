...
class CftlDataAccessConfigurator : public QObject
{
   Q_OBJECT
...
private:
    ...
    QString getEntryString();
    void getMapInitValues(QVariantMap& qMap, QVariantMap& qValues);
    QQuickWindow *CreateView();
public:
    CftlDataAccessConfigurator(QString p_qstrApplicationName);
    virtual ~CftlDataAccessConfigurator();
...
#endif // CSLDATAACCESSCONFIGURATOR_H

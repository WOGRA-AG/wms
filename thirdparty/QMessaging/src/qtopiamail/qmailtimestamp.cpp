...
QString QMailTimeStampPrivate::toString(QMailTimeStamp::OutputFormat format) const
{
    ...
    if (format == QMailTimeStamp::Rfc2822) {
        ...
        result = result.arg( QString::fromLocal8Bit( Days + ( originalDate.dayOfWeek() - 1 ) * 3, 3 ) );
        result = result.arg( QString::fromLocal8Bit( Months + ( originalDate.month() - 1 ) * 3, 3 ) );
...
/*!
    Constructs a nullptr QMailTimeStamp object. A nullptr timestamp is invalid.
*/

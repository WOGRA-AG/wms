...
CoeValueWidget::CoeValueWidget(const CdmMember* p_pCdmMember, QString p_qstrKeyname, QWidget* p_pqwParent)
: QObject(p_pqwParent),
  m_eOeDisplayType(edmStringDisplayTypeFormatted),
                                                        ...
                                                        QWidget* p_pqwParent)
{
   ...
   if (CHKPTR(p_pCdmMember))
   {
      ...
      {
      case eDmValueBool:
         pCoeValueWidget = new CoedtwBool(p_pCdmMember, p_qstrKeyname, p_pqwParent);
         break;
      case eDmValueInt:
      case eDmValueCounter:    
      case eDmValueLong:        
      case eDmValueFloat:             
      case eDmValueDouble:            
         pCoeValueWidget = new CoedtwDouble(p_pCdmMember, p_qstrKeyname, p_pqwParent);
         break;
      case eDmValueString:      
      case eDmValueCharacterDocument:
         pCoeValueWidget = new CoedtwString(p_pCdmMember, p_qstrKeyname, p_pqwParent);
         break;
      case eDmValueDate:              
         pCoeValueWidget = new CoedtwDate(p_pCdmMember, p_qstrKeyname, p_pqwParent);
         break;
      case eDmValueTime:              
         pCoeValueWidget = new CoedtwTime(p_pCdmMember, p_qstrKeyname, p_pqwParent);
         break;
      case eDmValueDateTime:          
         pCoeValueWidget = new CoedtwDateTime(p_pCdmMember, p_qstrKeyname, p_pqwParent);
         break;
      case eDmValueUser:          
         pCoeValueWidget = new CoedtwUser(p_pCdmMember, p_qstrKeyname, p_pqwParent);
         break;
      case eDmValueEnum:          
         pCoeValueWidget = new CoedtwEnum(p_pCdmMember, p_qstrKeyname, p_pqwParent);
         break;
      case eDmValueUserGroup:
         pCoeValueWidget = new CoedtwUserGroup(p_pCdmMember, p_qstrKeyname, p_pqwParent);
         break;
      case eDmValueContainerRef:
         pCoeValueWidget = new CoedtwContainerRef(p_pCdmMember, p_qstrKeyname, p_pqwParent);
         break;
      case eDmValueObjectRef:
         pCoeValueWidget = new CoedtwObjectRef(p_pCdmMember, p_qstrKeyname, p_pqwParent);
         break;
      default:
